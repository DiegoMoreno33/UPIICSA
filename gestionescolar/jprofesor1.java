 ...
 * @author Rugo
 */
public class jprofesor1 extends javax.swing.JFrame {
    public jprofesor1() {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String pnombre,snombre, apPaterno, apMaterno,matricula, calle, colonia, alcaldia,nInterior,nExterior,cp,usuario,contra;
        //int cp;
        ...
        if(pnombre.equals("") || apPaterno.equals("") || apMaterno.equals("") ||matricula.equals("")|| calle.equals("") || colonia.equals("")
            ...
            String sSQL = "INSERT INTO profesor(pnombre,snombre, apPaterno, apMaterno,matricula,calle, colonia, alcaldia,nInterior,nExterior,cp,usuario,contra)"
            + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
char c=evt.getKeyChar(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jprofesor1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jprofesor1().setVisible(true);
            }
        });
    }
